...
| 1 | Solar Cell | To recharge the battery. A 5.5V or 6V cell is needed to provide a high enough voltage to charge a 3.7V battery. The ESP32 board must have a compatible charging circuit. | [Example on Amazon](https://www.amazon.com/dp/B0CF5H9Y4X) |
